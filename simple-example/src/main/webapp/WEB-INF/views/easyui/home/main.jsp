...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#tt').tree({  
		    url:'${ctx}/common/json/tree_data.json',
		    animate:true,
		    lines:true,
		    //onlyLeafCheck:true,
		    //checkbox:true,
...
<body class="easyui-layout">
	<jsp:include page="../../../layouts/easyui/header.jsp" />
	<jsp:include page="../../../layouts/easyui/left.jsp" />
	<jsp:include page="../../../layouts/easyui/center.jsp" />
	<jsp:include page="../../../layouts/easyui/footer.jsp" />
</body>
