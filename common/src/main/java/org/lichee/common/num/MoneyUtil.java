...
public class MoneyUtil {
	 ...
	 */  
	public static String convert(String money) throws IllegalArgumentException {  
		...
		String result = "";  
		if (! integer.equals("0")) {  
		    result += integerToRmb(integer); // 整数部分  
		}  
	...
	/** 
	 * 将金额小数部分转换为中文大写 (小数点后面的内容)
	 * @param fraction 金额小数部分 
	 * @return string 中文大写 
	 */  
	public static String fractionToRmb(String fraction) {  
